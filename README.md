...
## Проверка экспорта, импорта и резервного копирования

Для проверки экспорта нужно выбрать в меню пункт экспорта одной коллекции
или всех коллекций. После выполнения операции в папке `exports/`
создаётся ZIP-архив.

Пример файлов экспорта:

```text
collectlog_collection_1_20260515_2219.zip
collectlog_all_20260515_2221.zip